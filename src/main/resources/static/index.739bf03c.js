...
class Grid {
    ...
    getCellsInrange(firstLetter, currentLetter) {
        ...
        if (firstLetter.y === currentLetter.y) for(let i = firstLetter.x; i <= currentLetter.x; i++)//console.log(this.gridArea.querySelector(`td[data-x="${i}"][data-y="${currentLetter.y}"]`));
        cellsInRange.push(this.gridArea.querySelector(`td[data-x="${i}"][data-y="${currentLetter.y}"]`));
        else if (firstLetter.x === currentLetter.x) for(let i1 = firstLetter.y; i1 <= currentLetter.y; i1++)//console.log(this.gridArea.querySelector(`td[data-x="${i}"][data-y="${currentLetter.y}"]`));
        cellsInRange.push(this.gridArea.querySelector(`td[data-x="${currentLetter.x}"][data-y="${i1}"]`));
        else if (currentLetter.y - firstLetter.y === currentLetter.x - firstLetter.x) {
            let delta = currentLetter.y - firstLetter.y;
            for(let i = 0; i < delta; i++)//console.log(this.gridArea.querySelector(`td[data-x="${i}"][data-y="${currentLetter.y}"]`));
    ...
    renderGrid(gridSize, wordGrid) {
        ...
        tbl.addEventListener("mousemove", (event)=>{
            if (this.wordSelectMode) {
                ...
                let letter = cell1.getAttribute("data-letter");
